...
<body>
    ...
    <div class="container">
        ...
        <div class="content-wrapper">
            ...
            <h1 class="text-center fw-bold" style="color: green; font-family: 'Montserrat', sans-serif;">SIGN UP AS
                ADMIN</h1>
            <form action="<?php echo e(url('/')); ?>/adminsignup" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" maxlength="5" class="form-control" id="ref_code" name="ref_code"
                            aria-describedby="ref_code_Help" required="required">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" maxlength="5" class="form-control" id="ref_code_gen" name="ref_code_gen"
                            aria-describedby="ref_code_Help" required="required">
...
<?php echo $__env->make('adminpanel/navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\edpay\Desktop\carrental\carrent\resources\views/adminpanel\adminsigup.blade.php ENDPATH**/ ?>