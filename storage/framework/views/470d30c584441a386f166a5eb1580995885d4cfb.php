...
<?php endif; ?>
    ...
    <form action="<?php echo e(url('/')); ?>/adminlogin" method="post">
      <?php echo csrf_field(); ?>
        <!-- Design of Box-->
        <div class="row">
...
<?php echo $__env->make('adminpanel/navbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\edpay\Desktop\carrental\carrent\resources\views/adminpanel\adminlogin.blade.php ENDPATH**/ ?>