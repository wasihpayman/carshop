...
<body>
    ...
    <footer class="footer">
        <div class="d-sm-flex justify-content-center justify-content-sm-between">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">RenCar <br> Rent cars at your
                convenience</span>

            <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Contact<br> Email:
                admin@rencar.com <br> Phone: +93 700 000 000 <br>Address: Mazar-e-Sharif, Balkh, Afghanistan </span>
        </div>
    </footer>
</body>
