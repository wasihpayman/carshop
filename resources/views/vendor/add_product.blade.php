...
<!-- brand select-->
    <div class="form-outline mb-2 w-30 m-auto">
        ...
        <div class="form-outline mb-2 w-30 m-auto">
            ...
            aria-describedby="product_price_help" placeholder="Enter minimum rental days" autocomplete="on" required="required" >
        </div>
        ...
        <div class="form-outline mb-2 w-30 m-auto">
            ...
            name="product_capacity"  placeholder="Enter car seat capacity" autocomplete="on" required="required">
        </div>
        <!-- product_ lisence -->
        <div class="form-outline mb-2 w-30 m-auto">
            ...
            name="product_lisence"  placeholder="Enter car lisence number" autocomplete="on" required="required">
        </div>
        <!-- Image-->
        <div class="form-outline mb-2 w-30 m-auto">
