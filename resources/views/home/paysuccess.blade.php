...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
        <a class="navbar-brand" href="{{url('/')}}">RenCar</a>
    ...
    <div class="payment-success-container">
        <h1>PAYMENT SUCCESSFUL!!!</h1>
        <p>Your payment was successful. Thank you for choosing RenCar!</p>
...
$store_id=urlencode("rencar6577403462649");
$store_passwd=urlencode("rencar6577403462649@ssl");
